    ...
    <div>
      ...
      <div>
        ...
        <div className="d-flex flex-column">
          ...
          <div
            className="container d-flex flex-lg-row col-12 flex-column align-items-sm-center"
          ...
          >
            ...
            <div
              data-aos="fade-left"
              data-aos-delay="600"
              className="d-flex flex-column align-items-center justify-content-center ms-lg-5 gap-5"
            >
          ...
          <div className="container w-100 d-flex flex-column align-items-center justify-content-center mt-5 mb-5">
